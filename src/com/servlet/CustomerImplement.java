...
public class CustomerImplement implements CustomerAction {
	...
	@Override
	public  boolean insertuser(String username,String NIC, String email, String password, String connectionNo) {
	...
	@Override
	public boolean checkuser(String NIC,String password){
